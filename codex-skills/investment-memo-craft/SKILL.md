...
- Use a simple title: `{Company} ({ticker}) Research Report`. Avoid adding "four-master synthesis" or "investment memo" to the title unless the user asks for that framing.
- Use dated filenames for reports: `{Company}-research-report-YYYYMMDD.md`.
...
- Use clear English step headings for readability, for example "Step 1: Core Data Overview", "Step 2: Business Essence Analysis", and "Step 8: Final Decision and Action List".
...
7. `Step 6: Industry and Civilization-Level Trends`
...
9. `Step 8: Final Decision and Action List`
