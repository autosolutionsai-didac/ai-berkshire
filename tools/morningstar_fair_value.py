#!/usr/bin/env python3
"""
Fetch every stock with a fair value estimate from the Morningstar screener API,
...
def main():
    ...
    print(f"{'='*80}\n")
    print(f"  {'Rank':>4} {'Code':<8} {'Company':<35} {'Price':>10} {'FairValue':>10} {'Upside':>8} {'Star':>4} {'Moat':<8} {'Industry':<20}")
