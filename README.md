...
> **🚀 One-command full pipeline — `/berkshire-skill <company/stock>`**
>
> Runs the entire research process on a single company end to end: **quality-screen → investment-team (four-master) → management-deep-dive → earnings-review → investment-checklist → thesis-tracker → a capstone Comprehensive Investment Decision Report.** It halts early on a hard-gate failure (quality-screen elimination or a checklist integrity veto), exactly like a real investment funnel. Each phase reuses the canonical workflow of the individual skill, so the 18 standalone skills below remain the single source of truth and still work on their own.
>
> ```bash
...
|-------|---------|-------------|
| [`/berkshire-skill`](skills/berkshire-skill.md) | One-command full research pipeline | Take one company through the whole funnel and end with a capstone decision report — halts early on a hard-gate failure |
...
```bash
# Full Pipeline (one command, whole company end to end)
/berkshire-skill Tencent
...
Full reports: [AI Compute](reports/) · [AI Models](reports/) · [AI Applications](reports/) · [AI Infrastructure & Power](reports/)
...
|---------|-----------|----------------|--------|
| Pinduoduo (PDD) | `/investment-team` | Composite 3.4/5 — extremely cheap but 10-year certainty insufficient; suitable for moderate position | [View Report](reports/) |
| Tencent (0700.HK) | `/investment-research` | Social monopoly + superior capital allocation; 14x forward P/E is reasonable-to-low | [View Report](reports/) |
| 7-Company Comparison | `/investment-checklist` | Moutai & Tencent pass; NVIDIA, Meituan & Kuaishou conditional; Pinduoduo & Pop Mart gray zone | [View Report](reports/) |
| Master Holdings Tracker | Custom Research | Buffett / Li Lu / Duan Yongping latest 13F holdings + PDD cost-basis analysis | [View Report](reports/) |
